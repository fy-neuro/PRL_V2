...
##load Data
```{r}
sobj<-readRDS("/storage/liuxiaodongLab/fanyi/FY/PRL_V2/20241230-4-15sample_QC/PRL_15sampleQC.rds")
sobj<-readRDS("../data/sobj_PD_MNN.rds")
```
##Intergrate
FastMNNIntegration
```{r}
...
# File paths
outRDS <- paste0("../data/sobj_PD_", identifier, ".rds")
outPDF_QC <- paste0("../data/sobj_PD_", identifier, "_QC.pdf")
outPDF <- paste0("../data/sobj_PD_", identifier, ".pdf")
